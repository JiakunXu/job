...
import com.jk.jobs.framework.util.ClientUtil;
import com.jk.jobs.framework.util.DateUtil;
...
public class ActionMonitorInterceptor implements Interceptor {
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		com.jk.jobs.framework.annotation.ActionMonitor actionLog =
			method.getAnnotation(com.jk.jobs.framework.annotation.ActionMonitor.class);
		if (actionLog != null) {
